      ...
      <form>
        ...
        <br/>
            ...
            <Index data={{index_id: "password" , index:"Password", required: "*"}} />
                ...
                <br />
                <a className='text-blue-600 text-sm hover:underline hover:text-lg cursor-pointer' href="">Forgot your password ?</a>
                </div>
            <div className='mt-3'>
                <button className=' bg-blue-500 border border-black rounded-lg pl-3  py-1.5 size-3/4 mt-1 '>Sign In</button>
                <br />
                <p className='mt-2 '>Need a account?  <span onClick={handleNew} className='text-blue-600 text-sm hover:underline hover:text-lg cursor-pointer' >Register</span> </p>
            </div>
    </form>:<Register/>
    }
